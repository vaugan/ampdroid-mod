...
public class TabVideosActivityGroup extends ActivityGroup {

   // Keep this in a static variable to make it accessible for all the nesten
   // activities, lets them manipulate the view
   private static TabVideosActivityGroup mGroup;
   
   public static TabVideosActivityGroup getGroup(){
      return mGroup;
   }
   ...
   protected void onCreate(Bundle _savedInstanceState) {
      ...
      View view = getLocalActivityManager().startActivity("VideosActivity",
            new Intent(this, TabVideosActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP))
            .getDecorView();
   ...
   public void onBackPressed() {
      TabVideosActivityGroup.mGroup.back();
      return;
   }
