...
public class TabMusicSharesActivityGroup extends ActivityGroup {

   // Keep this in a static variable to make it accessible for all the nesten
   // activities, lets them manipulate the view
   private static TabMusicSharesActivityGroup mGroup;

   public static TabMusicSharesActivityGroup getGroup() {
      return mGroup;
   }
   ...
   protected void onCreate(Bundle _savedInstanceState) {
      ...
      Intent intent = new Intent(this, TabMusicSharesActivity.class);
      intent.putExtra("activity_group", "shares");
   ...
   public void onBackPressed() {
      TabMusicSharesActivityGroup.mGroup.back();
      return;
   }
